...
<span class="left"><a href="files/review_vr/ReviewVR_2.pdf"><img src="img/ReviewVR_2_.png"><p class=""><br /><b><i class="icon-download"></i>Download PDF</b></p></a></span>
...
<p><strong>MIS decision-making in SVRAs in which the DSU is different from the DSA (Figure 1):</strong> Nearly half (21) of the 46 SVRAs indicated that primary decision-making authority on MIS hardware and software was with the DSA or another entity in the state government. However, 42 out of 46 SVRAs indicated that they had control over decisions on data analysis and use.</p>

<<<<<<< HEAD
<p><strong>MIS decision-making in SVRAs in which the DSU is the same as the DSA (Figure 2):</strong> Eighteen of the 25 SVRAs reported that the DSU was the primary decision maker regarding MIS hardware and software. All 25 agencies reported that the DSU was the primary decision maker for data analysis and use.</p>
...
<div><iframe width="760px" title="Column Chart: Review VR No 2, Figure 1" height="646px" src="https://opendata.socrata.com/w/ayvi-3yb6/y34g-bnf3?cur=FtnGD0XfbE1&from=root" frameborder="0" scrolling="no"><a href="https://opendata.socrata.com/dataset/Column-Chart-Review-VR-No-2-Figure-1/ayvi-3yb6" title="Column Chart: Review VR No 2, Figure 1" target="_blank">Column Chart: Review VR No 2, Figure 1</a></iframe><p><a href="http://www.socrata.com/" target="_blank">Powered by Socrata</a></p></div>
