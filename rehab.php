...
<h3>Rehabilitation
 Rates by RSA Disability Category</h3>
<p>The
 rehabilitation rates for each type of disability at agency level were generated using RSA-911 FY2011 personal level data following these steps.</p>
<ol>
 
 <li>Individuals were categorized into nine mutually exclusive disability groups (Visual, Hearing, Orthopedic, Intellectual, Substance abuse, Mental health, Learning disability, Traumatic brain injury and Other) based on the primary impairment and cause of
 primary impairment reported. Nine dichotomized dummy variables were created.</li>
 
 <li>Individuals were categorized into two mutually exclusive outcome groups—closed after an employment outcome with an IPE (Status 26) and no employment outcome with an IPE (Status 28). Two binary dummy variables were created for these two groups.  We then
 created our new variable by multiplication of the disability group with the outcome group:</li>
 ...
 <li>Finally, rehabilitation rate was calculated by dividing the total number of status 26 of a specific disability by the total number of  IPEs (status 26 + Status 28) of that specific disability (i.e. ∑(Visual x Status 26) / ∑ [Visual x (Status 26 + Status
 28)].</li>
</ol>
<div><iframe
 width="760px" title="Chart: Rehabilitation Rate by RSA Disability Category (General / Combined Agencies)" height="646px" src="https://opendata.socrata.com/w/3ggm-6fg4/y34g-bnf3?cur=IQXOrUeYPQ9&from=root"
 frameborder="0" scrolling="no"><a href="https://opendata.socrata.com/dataset/Chart-Rehabilitation-Rate-by-RSA-Disability-Catego/3ggm-6fg4"
 title="Chart: Rehabilitation Rate by RSA Disability Category (General / Combined Agencies)" target="_blank">Chart: Rehabilitation Rate by RSA Disability Category (General / Combined Agencies)</a></iframe><p><a href="http://www.socrata.com/"
 target="_blank">Powered by Socrata</a></p></div>
<p>Source:
 RSA-911 FY2011</p>
		</article>
